...
namespace tdogl {
    ...
    *
    * Set the properties of the camera, then use the 'matrix' method to get the camera
    * matrix for use in the vertex shader.
    *
    ...
    */
    ...
    public:
        ...
        */
        ...
        /** A unit vector representing the direction out of the bottom of the camera*/
        glm::vec3 down() const;

        /**
        * The combined camera transformation matrix, including perspective projection.
        *
        * This is complete matrix to use in the vertex shader
        */
